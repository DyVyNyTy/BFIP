...
def map_phase(dH_range=(-80, -30), dS_range=(-0.20, 0.00), step=2.5, amp=1.0):
...
def plot_map(dH_vals, dS_vals, Z):
    ...
    plt.title('Ca²⁺ BFIP Activation Map (ΔH–ΔS, Amp = 1.0)')
    plt.tight_layout()
    plt.savefig('Ca2_BFIP_activation_map.png', dpi=600)
    plt.show()
